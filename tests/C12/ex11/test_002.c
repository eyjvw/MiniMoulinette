...
int main(void){t_list *l = mk("dup", mk("dup", NULL));t_list *r = ft_list_find(l, (void *)"dup", cmps);if (!r) printf("NULL");else printf("[%s]next=%d", (char *)r->data, r->next == NULL);return 0;}
